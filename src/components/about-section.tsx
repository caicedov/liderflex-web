        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-8 leading-relaxed">
              Desde operaciones mineras hasta instalaciones manufactureras, nuestras soluciones hidráulicas impulsan las
              aplicaciones más exigentes. Combinamos artesanía tradicional con tecnología de vanguardia para entregar
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <Card className="border-2 border-yellow-400 hover:shadow-lg transition-shadow">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Proporcionar soluciones hidráulicas superiores que superen las expectativas a través de productos
                innovadores, servicio excepcional y experiencia técnica, ayudando a nuestros clientes a lograr la
                excelencia operacional con los más altos estándares de seguridad y confiabilidad.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 border-blue-600 hover:shadow-lg transition-shadow">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                Ser el proveedor líder de soluciones hidráulicas en Sudamérica, reconocido por nuestra innovación,
                calidad y enfoque centrado en el cliente. Visualizamos un futuro donde nuestros productos permitan a las
                industrias operar de manera más eficiente y sostenible.
              </p>
            </CardContent>
          </Card>
        </div>
