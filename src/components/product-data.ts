...
export const conexiones_hidraulicas: Product[] = [
  ...
  // -------------------------------
  {
    ...
    availableSizes: [
      { code: "HJIC0404", size: '1/4" - 04x04 - 7/16x20' },
      { code: "HJIC0405", size: '1/4" - 04x05 - 1/2x20' },
      { code: "HJIC0406", size: '1/4" - 04x06 - 9/16x18' },
      { code: "HJIC0505", size: '5/16" - 05x05 - 1/2x20' },
      { code: "HJIC0506", size: '5/16" - 05x06 - 9/16x18' },
      { code: "HJIC0606", size: '3/8" - 06x06 - 9/16x18' },
      { code: "HJIC0608", size: '3/8" - 06x08 - 3/4x16' },
      { code: "HJIC0808", size: '1/2" - 08x08 - 3/4x16' },
      { code: "HJIC0810", size: '1/2" - 08x10 - 7/8x14' },
      { code: "HJIC0812", size: '1/2" - 08x12 - 1.1/16x12' },
      { code: "HJIC1010", size: '5/8" - 10x10 - 7/8x14' },
      { code: "HJIC1012", size: '5/8" - 10x12 - 1.1/16x12' },
      { code: "HJIC1212", size: '3/4" - 12x12 - 1.1/16x12' },
      { code: "HJIC1216", size: '3/4" - 12x16 - 1.5/16x12' },
      { code: "HJIC1616", size: '1" - 16x16 - 1.5/16x12' },
      { code: "HJIC1620", size: '1" - 16x20 - 1.5/8x12' },
      { code: "HJIC2020", size: '1.1/4" - 20x20 - 1.5/8x12' },
      { code: "HJIC2024", size: '1.1/4" - 20x24 - 1.7/8x12' },
      { code: "HJIC2424", size: '1.1/2" - 24x24 - 1.7/8x12' },
      { code: "HJIC3232", size: '2" - 32x32 - 2.1/2x12' },
    ],
  },
  {
    id: "fjx_45",
    ...
    availableSizes: [
      { code: "HJIC450404", size: `1/4" | 04 X 04 | 7/16 X 20` },
      { code: "HJIC450405", size: `1/4" | 04 X 05 | 1/2 X 20` },
      { code: "HJIC450406", size: `1/4" | 04 X 06 | 9/16 X 18` },
      { code: "HJIC450505", size: `5/16" | 05 X 05 | 1/2 X 20` },
      { code: "HJIC450506", size: `5/16" | 05 X 06 | 9/16 X 18` },
      { code: "HJIC450606", size: `3/8" | 06 X 06 | 9/16 X 18` },
      { code: "HJIC450608", size: `3/8" | 06 X 08 | 3/4 X 16` },
      { code: "HJIC450808", size: `1/2" | 08 X 08 | 3/4 X 16` },
      { code: "HJIC450810", size: `1/2" | 08 X 10 | 7/8 X 14` },
      { code: "HJIC450812", size: `1/2" | 08 X 12 | 1.1/16 X 12` },
      { code: "HJIC451010", size: `5/8" | 10 X 10 | 7/8 X 14` },
      { code: "HJIC451012", size: `5/8" | 10 X 12 | 1.1/16 X 12` },
      { code: "HJIC451212", size: `3/4" | 12 X 12 | 1.1/16 X 12` },
      { code: "HJIC451216", size: `3/4" | 12 X 16 | 1.5/16 X 12` },
      { code: "HJIC451616", size: `1" | 16 X 16 | 1.5/16 X 12` },
      { code: "HJIC451620", size: `1" | 16 X 20 | 1.5/8 X 12` },
      { code: "HJIC452020", size: `1"1/4 | 20 X 20 | 1.5/8 X 12` },
      { code: "HJIC452024", size: `1"1/4 | 20 X 24 | 1.7/8 X 12` },
      { code: "HJIC452424", size: `1"1/2 | 24 X 24 | 1.7/8 X 12` },
      { code: "HJIC453232", size: `2" | 32 X 32 | 2.1/2 X 12` },
    ],
  },
  {
    id: "fjx_90",
    ...
    availableSizes: [
      { code: "HJIC900404", size: `1/4" | 04 X 04 | 7/16 X 20` },
      { code: "HJIC900405", size: `1/4" | 04 X 05 | 1/2 X 20` },
      { code: "HJIC900406", size: `1/4" | 04 X 06 | 9/16 X 18` },
      { code: "HJIC900505", size: `5/16" | 05 X 05 | 1/2 X 20` },
      { code: "HJIC900506", size: `5/16" | 05 X 06 | 9/16 X 18` },
      { code: "HJIC900606", size: `3/8" | 06 X 06 | 9/16 X 18` },
      { code: "HJIC900608", size: `3/8" | 06 X 08 | 3/4 X 16` },
      { code: "HJIC900808", size: `1/2" | 08 X 08 | 3/4 X 16` },
      { code: "HJIC900810", size: `1/2" | 08 X 10 | 7/8 X 14` },
      { code: "HJIC900812", size: `1/2" | 08 X 12 | 1.1/16 X 12` },
      { code: "HJIC901010", size: `5/8" | 10 X 10 | 7/8 X 14` },
      { code: "HJIC901012", size: `5/8" | 10 X 12 | 1.1/16 X 12` },
      { code: "HJIC901212", size: `3/4" | 12 X 12 | 1.1/16 X 12` },
      { code: "HJIC901216", size: `3/4" | 12 X 16 | 1.5/16 X 12` },
      { code: "HJIC901616", size: `1" | 16 X 16 | 1.5/16 X 12` },
      { code: "HJIC901620", size: `1" | 16 X 20 | 1.5/8 X 12` },
      { code: "HJIC902020", size: `1"1/4 | 20 X 20 | 1.5/8 X 12` },
      { code: "HJIC902024", size: `1"1/4 | 20 X 24 | 1.7/8 X 12` },
      { code: "HJIC902424", size: `1"1/2 | 24 X 24 | 1.7/8 X 12` },
      { code: "HJIC903232", size: `2" | 32 X 32 | 2.1/2 X 12` },
    ],
  },
  {
    id: "mj_jic",
