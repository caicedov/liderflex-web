export default function ProductImageCard({ product }) {
  return (
    ...
    >
      ...
      {/** Overlay con blur */}
      <div className="absolute inset-0 bg-black bg-opacity-40 backdrop-blur-sm transition-all duration-300 group-hover:bg-opacity-60 group-hover:backdrop-blur-md" />
