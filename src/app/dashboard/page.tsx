      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-obsidian-900">{stats.totalQuotations}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{stats.approvedQuotations}</div>
              <p className="text-xs text-muted-foreground">Listas para procesar</p>
            </CardContent>
          </Card>
                        ...
                        <div className="flex items-center space-x-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              {quotation.total_items} productos • {new Date(quotation.created_at).toLocaleDateString()}
                            </p>
                          </div>
                        </div>
