            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <Image
                  ...
                  alt="Instalaciones de Liderflex"
                  width={600}
                  height={400}
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Card className="border-2 border-obsidian-800">
                <CardContent className="p-8 text-center">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                <div className="bg-obsidian-100 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Users className="w-10 h-10 text-obsidian-800" />
                </div>
                <h3 className="text-xl font-bold mb-3">
